...
type Session struct {
	...
	Season      int16     `gorm:"not null" json:"season"` // Year
	...
	TrackTemperature  *int16            `gorm:"type:smallint" json:"track_temperature"`     // 2-digit integer
...
type UpcomingSessionTitle struct {
	ID       uuid.UUID `gorm:"type:uuid;primary_key;default:gen_random_uuid()" json:"id"`
	RaceName string    `gorm:"type:varchar(100);not null" json:"race_name"`
...
func (UpcomingSessionTitle) TableName() string {
	return "sessions"
}
